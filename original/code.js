...
//
//       canvas.path(hexagon).attr({stroke: '#AAAAAA', fill: fillfn(constituency[2]), title: constituency[2]}).attr('id', 'jenny');
//     }
//   }
// })();
...
var loadVisualisation = function(callback) {
  ...
  var svg = d3.select('#frame').append('svg').attr('width', 500).attr('height', 500).attr('transform', 'scale(1.5)');
  var map = UK.HexMap();
